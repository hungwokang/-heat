...
function HeadSitModule.startSit(targetPlayer)
    ...
    HeadSitModule.sitConnection = RunService.Heartbeat:Connect(function()
        if targetHead and targetHead.Parent and rootPart and rootPart.Parent then
            local targetPos = targetHead.Position + Vector3.new(0, 1, 0) -- Offset above head
...
function GUIModule.setupGUI()
    ...
    local function buildMainTab()
        ...
        orbitTabBtn.Parent = scroll
        orbitTabBtn.Size = UDim2.new(1, -10, 0, 25)
        ...
        shootTabBtn.Parent = scroll
        shootTabBtn.Size = UDim2.new(1, -10, 0, 25)
        ...
        local headsitTabBtn = Instance.new("TextButton")
        headsitTabBtn.Name = "HeadsitTabBtn"
        headsitTabBtn.Parent = scroll
        headsitTabBtn.Size = UDim2.new(1, -10, 0, 25)
        headsitTabBtn.BackgroundColor3 = Color3.new(0, 0, 0)
        headsitTabBtn.BackgroundTransparency = 0.6
        headsitTabBtn.BorderColor3 = Color3.fromRGB(255, 0, 0)
        headsitTabBtn.BorderSizePixel = 1
        headsitTabBtn.Font = Enum.Font.Code
        headsitTabBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
        headsitTabBtn.TextSize = 12
        headsitTabBtn.Text = "HEADSIT"
        headsitTabBtn.TextXAlignment = Enum.TextXAlignment.Center
        headsitTabBtn.MouseButton1Click:Connect(function()
            clearTabContent()
            buildHeadSitTab()
        end)
        updateScrollCanvas()
    ...
    function buildHeadSitTab()
        ...
        sitText.Name = "SitText"
        sitText.Parent = scroll
        sitText.Size = UDim2.new(1, -10, 0, 15)
        ...
        sitBtn.Name = "SitBtn"
        sitBtn.Parent = scroll
        sitBtn.Size = UDim2.new(1, -10, 0, 20)
        sitBtn.BackgroundColor3 = Color3.new(0, 0, 0)
        sitBtn.BackgroundTransparency = 0.6
        sitBtn.BorderColor3 = Color3.fromRGB(255, 0, 0)
        sitBtn.BorderSizePixel = 1
        sitBtn.Font = Enum.Font.Code
        sitBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
        sitBtn.TextSize = 12
        sitBtn.Text = "SIT"
        sitBtn.TextXAlignment = Enum.TextXAlignment.Center
